...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { destination_id: @attraction.destination_id, image: @attraction.image, name: @attraction.name }
    end
  ...
  test "should update attraction" do
    patch :update, id: @attraction, attraction: { destination_id: @attraction.destination_id, image: @attraction.image, name: @attraction.name }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
