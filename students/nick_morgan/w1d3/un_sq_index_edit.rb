...
def select_station(line_text, station_text)
	puts "#{line_text}? (n) (l) (6)"
	...
	puts "#{station_text}? #{stops}"

	input = gets.chomp

	index = stops.index(input)

	return [line, index]

end

line_start, start_index = select_station("Starting line", "Start point")
...
elsif end_index.to_i < unsq1_index.to_i 
