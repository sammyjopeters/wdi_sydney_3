...
lines = {:n => { "times" => 4, "34th" => 3, "28th" => 2, "23rd" => 1, "union" => 0, "8th" => -1 },
...
# THis makes the hash data available whereever I declare Linestart or linefinish. AMAZEBALLS
	...
	lineStart = lines[lineStart.downcase.to_sym]
	puts "Whoops! I don't know what line you mean." if lineStart.nil?
...
## Talk to the user, fool!!
	...
	puts "\nWhat line is your first station at? (N) Line, (L) Line, (S)ix Line..."
	...
	stations = lines[lineStart.downcase.to_sym].keys
	puts stations.map(&:to_s).join(', ')

	stationStart = gets.chomp
	puts "wrong!" if !stations.include?(stationStart)
